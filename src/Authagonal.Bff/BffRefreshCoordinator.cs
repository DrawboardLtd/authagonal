...
/// <summary>Keeps a session's access token fresh, refreshing single-flight per session so concurrent SPA
/// requests never each spend the (rotating) refresh token.</summary>
