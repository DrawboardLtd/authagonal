...
public interface ITokenService
{
    ...
    Task<string> CreateRefreshTokenAsync(AuthUser user, OAuthClient client, IEnumerable<string> scopes, IEnumerable<string>? resources = null, DateTimeOffset? originalCreatedAt = null, DateTimeOffset? sessionMaxExpiresAt = null, CancellationToken ct = default);
