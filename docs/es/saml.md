...
El SSO iniciado por el IdP esta soportado — el endpoint ACS maneja respuestas sin `InResponseTo` (omitiendo la validacion de replay para respuestas no solicitadas).
