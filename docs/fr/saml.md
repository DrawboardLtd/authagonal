...
Le SSO initie par l'IdP est pris en charge -- le point de terminaison ACS gere les reponses sans `InResponseTo` (en ignorant la validation de rejeu pour les reponses non sollicitees).
